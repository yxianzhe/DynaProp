        ...
        mbDeactivateLocalizationMode(false)
{
    ...
    cout << endl <<
    "DynaProp Copyright (C) 2022 Xianzhe Yuan, Huazhong University of Science and Technology." << endl <<
    "This is a modified version of DynaSLAM by Berta Bescos, University of Zaragoza." << endl;
